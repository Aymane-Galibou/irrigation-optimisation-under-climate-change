...
climate_models = ['ACCESS-CM2', 'EC-Earth3', 'CNRM-CM6-1']
...
for climate_model in climate_models:
    print(f"==== Climate Change Model :   {climate_model} =====")
    ...
    for climate_scenario in ['ssp245', 'ssp585']:
        ...
        if ml_dataset is not None:
            ...
            ml_dataset['feature_climate_model'] = climate_model  
...
final_dataset.to_csv('./backend/ml_assets/data/xdata.csv', index=False)
